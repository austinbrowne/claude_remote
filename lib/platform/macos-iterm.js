...
function sendControlChar(charCode, tty) {
  ...
  return new Promise((resolve, reject) => {
    ...
    `;
    execFile('osascript', ['-e', appleScript], { timeout: OSASCRIPT_TIMEOUT_MS }, (err, stdout) => {
...
function injectCommand(command, tty) {
  ...
  return new Promise((resolve, reject) => {
    ...
    execFile('osascript', ['-e', appleScript], { timeout: OSASCRIPT_TIMEOUT_MS }, (err, stdout, stderr) => {
      if (err) {
...
function sendEscapeKey(tty) {
  ...
  return new Promise((resolve, reject) => {
    ...
    execFile('osascript', ['-e', appleScript], { timeout: OSASCRIPT_TIMEOUT_MS }, (error, stdout) => {
...
function sendModeToggle() {
  return new Promise((resolve, reject) => {
    ...
    execFile('osascript', ['-e', appleScript], { timeout: OSASCRIPT_TIMEOUT_MS }, (error) => {
      if (error) {
...
async function healthCheck() {
  return new Promise((resolve) => {
    execFile('which', ['osascript'], { timeout: 2000 }, (err) => {
      if (err) {
