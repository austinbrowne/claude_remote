      ...
      try {
        ...
        while (continueReading) {
          ...
          if (stats.size > lastPosition) {
            ...
            // Must run BEFORE Phase 3 so cross-batch resolutions are processed
            // before new items are classified. Map.delete during iteration is
            // safe per ECMAScript spec (already-visited keys unaffected).
